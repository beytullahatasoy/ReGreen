...
export function PrototypeShell({ mode, children }: { mode: "organisation" | "volunteer"; children: ReactNode }) {
  return <div className="rc-shell">
    <header className="rc-header"><a className="rc-brand" href="/" aria-label="ReGreen Expert Workspace"><span className="rc-brand__logo"><img src="/brand/regreen-logo-source.png" alt="" /></span><span><strong>ReGreen</strong><small>Recovery intelligence</small></span></a>
      ...
      <div className="rc-header__meta"><span className="rc-live-dot" /> Demo workspace</div>
    </header>{children}
